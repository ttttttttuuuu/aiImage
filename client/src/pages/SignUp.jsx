...
const SignUp = (props) => {
  ...
  async function fetchSignUp() {
    ...
    if (form.email !== "" && form.password.length >= 8) {
      const req = await axios.post(`${url}/api/v1/auth/signup`, {
        headers: {
    ...
    if (form.password.length < 8) {
      setErr(true);
      setErrorMsg("Password at least 8 characters");
    }
    if (form.password.length < 8 && form.email === "") {
      setErr(true);
      setErrorMsg("Please finish sign up form !");
    }
    setIsLoading(false);
  }
    ...
    return (
      <div className="w-full h-full">
        ...
        <div className="w-full h-full flex justify-center ">
          <div className="w-[400px] min-h-[540px]  ">
            {/* title */}
            <header className="w-[400px] h-[136px] pt-[40px] pb-[24px]  px-[40px]">
              <h1 className="text-3xl font-bold mt-[24px]">
                Create Your Account
              </h1>
            </header>
            ...
            <div className="w-[400px] h-[471px] px-[40px] pb-[40px] ">
              {/* email */}
              ...
              <div className="">
                <input
                  className={` w-[320px] h-[52px] flex justify-center  mt-[12px] border focus:border-blue-500 px-[16px] ${
                    form.email === "" && err && "border-red-500"
                  } text-base rounded `}
              ...
              {/* error box  */}
              <div
                className={`border w-[320px] h-[78px] mt-[8px] py-[14px] px-[16px] rounded ${
                ...
                data-shown="true"
              >
                <div className="w-[286px] h-[48px]">
                  <ul className="w-full h-full">
                    <li className="">
                      <div className="text-left text-sm w-[200px] h-[48px]">
                        ...
                        <ul>
                          <li
                            className={`mt-[8px] ${
                              form.password.length >= 8 && "text-blue-500"
                            } `}
                          >
                            <span className="c5da20fc9">
              ...
              {/* submit button */}
              <div className="w-[320px] h-[52px]  bg-blue-500 mt-[24px]  text-white text-xl rounded cursor-pointer">
                <button
